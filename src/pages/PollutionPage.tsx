...
export default function PollutionPage() {
    ...
    return (
        <>
            <h1>Загрязнения</h1>
            <p>На представленной странице можно ознакомиться с актуальными данными о качестве воздуха в различных населенных пунктах. Для этого достаточно ввести желаемый адрес и нажать на кнопку "Получить".</p>
